...
import TranslationManager from './modules/state/TranslationManager.js';
import UIController from './modules/ui/UIController.js';
import AnalyticsManager from './modules/ui/AnalyticsManager.js';

declare global {
  interface Window {
    __APP__?: {
      StateManager: typeof StateManager;
      TranslationManager: typeof TranslationManager;
