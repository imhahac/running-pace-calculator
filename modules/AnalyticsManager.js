...
export class AnalyticsManager {
    ...
    static trackCalculationSuccess(sourceId, mode) {
    ...
    static trackCalculationRejected(sourceId, mode, reason) {
        const state = this.readState();
    ...
    static trackFinishTimeValidation(isValid, expectedFormat) {
        const state = this.readState();
        if (isValid) {
